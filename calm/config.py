...
_DATASET_NAMES = ('CUB', 'ILSVRC', 'OpenImages', 'church_outdoor', 'celebA_512')
...
def get_configs():
    ...
    parser.add_argument('--data_root', metavar='/PATH/TO/DATASET',
                        default='/root/workspace/dissect/newGradVersion/classification/celebAHQ_512/',
                        help='path to dataset images')
    '''
    parser.add_argument('--dataset_name', type=str, default='church_outdoor', choices=_DATASET_NAMES)
    parser.add_argument('--data_root', metavar='/PATH/TO/DATASET',
                        default='/root/workspace/dissect/gradVersion/classification/lsun_church/',
                        help='path to dataset images')
    '''
    # Util
    ...
    parser.add_argument('--architecture', default='resnet50',
                        ...
                        help='model architecture: ' +
                             ...
                             ' (default: resnet50)')
    parser.add_argument('--attribution_method', type=str, default='CALM-ML',
